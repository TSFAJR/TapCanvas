...
export const WORKFLOW_ICON_NODE_WIDTH = WORKFLOW_ICON_NODE_SIZE
export const WORKFLOW_ICON_NODE_HEIGHT = WORKFLOW_ICON_NODE_SIZE
export const WORKFLOW_RESULT_NODE_WIDTH = 240
export const WORKFLOW_RESULT_NODE_HEIGHT = 135
export const WORKFLOW_ICON_NODE_FLOW_GAP_X = 228
