...
const existingNodes = [
  ...
  {
    id: "agent-generate_scene_references-01JSTAPX-scene-01",
    kind: "image",
    preset: "reference",
    data: {
      label: "李家老宅拆迁现场 场景参考图",
      productionLayer: "scene_reference",
      referenceType: "scene",
    },
  },
  {
    id: "agent-generate_scene_references-01JSTAPX-scene-02",
    kind: "image",
    preset: "reference",
    data: {
      label: "李家守灵卧室翻书 场景参考图",
      productionLayer: "scene_reference",
      referenceType: "scene",
    },
  },
  {
    id: "agent-generate_scene_references-01JSTAPX-scene-03",
    kind: "image",
    preset: "reference",
    data: {
      label: "破败土屋异境初现 场景参考图",
      productionLayer: "scene_reference",
      referenceType: "scene",
    },
  },
  {
    id: "agent-generate_scene_references-01JSTAPX-char-01",
    kind: "image",
    preset: "reference",
    data: {
      label: "李长安 人物参考图",
      productionLayer: "character_reference",
      referenceType: "character",
    },
  },
  {
    id: "agent-generate_scene_references-01JSTAPX-char-02",
    kind: "image",
    preset: "reference",
    data: {
      label: "李老头 人物参考图",
...
const existingEdges = [
  {
    id: "e1",
    source: "agent-generate_scene_references-01JSTAPX-scene-01",
    target: sourceNodeId,
  ...
  {
    id: "e2",
    source: "agent-generate_scene_references-01JSTAPX-scene-02",
    target: sourceNodeId,
    sourceHandle: "out-image",
    targetHandle: "in-image",
  },
  {
    id: "e3",
    source: "agent-generate_scene_references-01JSTAPX-scene-03",
    target: sourceNodeId,
    sourceHandle: "out-image",
    targetHandle: "in-image",
  },
  {
    id: "e4",
    source: "agent-generate_scene_references-01JSTAPX-char-01",
    target: sourceNodeId,
    sourceHandle: "out-image",
    targetHandle: "in-image",
  },
  {
    id: "e5",
    source: "agent-generate_scene_references-01JSTAPX-char-02",
    target: sourceNodeId,
    sourceHandle: "out-image",
    targetHandle: "in-image",
  },
...
const outPath = path.join(__dirname, "fixture-incremental.json");
...
console.log(`existingScenes=3 existingChars=2`);
console.log(`expected: agent should add 1-3 missing scenes (分钱/守灵宴 setting) + maybe 大伯母 char`);
